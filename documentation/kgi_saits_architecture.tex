...
\title{Knowledge-Guided Imputation (KGI) Integration in SAITS}
...
\section{Architecture Overview and Forward Pass}
...
\subsection{Phase 1: Ingestion and Positional Encoding (Vanilla Transformer base)}
...
\subsection{Phase 2: KGI Semantic Injection (The Multimodal Fusion)}
...
\subsection{Phase 3: DMSA Blocks and Imputation}
...
\subsection{Phase 4: Output Combination and Backpropagation}
